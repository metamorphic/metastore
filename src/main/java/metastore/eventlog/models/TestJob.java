 ...
 */
@Entity
@Table(name = "jobs_test", schema = "cxp")
public class TestJob {

    @Id
    @SequenceGenerator(name = "test_job_id_seq", sequenceName = "jobs_test_job_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "test_job_id_seq")
